...
export default async function Game({ searchParams }: PageProps) {
  ...
  return (
    <main className="flex min-h-screen flex-col md:mx-4 md:px-12 md:py-6">
      <Header />
      <div className="items-center mx-4 gap-x-4 grid [grid-template-areas:'score-p1_score-p2''board_board'] lg:[grid-template-areas:'score-p1_board_score-p2'] lg:[grid-template-columns:1.5fr_5fr_1.5fr] lg:gap-x-12">
